...
class Assessment(BaseModel):
    ...
    psychologist_id = db.Column(db.Integer, db.ForeignKey("psychologists.id"), nullable=False)  # Explicit foreign key
    ...
    psychologist = db.relationship("Psychologist", backref="assessments", lazy=True)  # Define relationship
    ...
    def __init__(self, child_id, task_description, days_to_complete, frequency=1):
        ...
        self.psychologist_id = 9999  # Default fixed ID

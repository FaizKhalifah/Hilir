...
from app.controllers.psychologist_controller import (
    ...
    chat_with_child,  # Import the generalized chat_with_child function
)
...
psychologist_bp.route("/child/add_assessment", methods=["POST"])(psychologist_required(add_assessment))
...
# General chat route with @psychologist_required
psychologist_bp.route('/chat', methods=['POST'])(psychologist_required(chat_with_child))
